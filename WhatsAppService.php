...
{
        private $baseUrl = 'https://evolution.neox.site';
        private $instanceName = 'Chatbot';
        private $instanceToken = '703B8787C744-48F0-A1E4-ECAEEE137F7C';
        ...
        public function sendMessage($remoteJid, $text)
        {
                ...
                if ($httpCode >= 200 && $httpCode < 300) {
                        ...
                        error_log("Error API WhatsApp ($httpCode): $response");
                        return false;
                }
        }
